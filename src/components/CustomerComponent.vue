<template>
    <div>
        <span class="p-float-label p-input-icon-right full">
            ...
            <label for="username"
                :class="{ ' full p-inputtext-sm p-error': v$.username.$invalid && props.submitted }">{{
                        $t('cliente.nome')
                }}*</label>
        </span>
        ...
        <div class="width-45">
            <span class="p-float-label p-input-icon-right full">
                ...
                <InputMask mask="999.999.999-99" required id="cpf" type="text" v-model="v$.cpf.$model"
                    ...
                    :class="{ 'full input-size p-invalid': v$.cpf.$invalid && props.submitted }" />
    ...
    <div class="flex-row">
        <div class="width-45">
            <span class="p-float-label p-input-icon-right full">
                ...
                <label for="email" :class="{ 'p-error': v$.email.$invalid && props.submitted }">{{ $t('cliente.email')
                }}*</label>
            </span>
